                ...
                <div className="container mx-auto px-4 max-w-6xl relative z-10">
                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 md:p-12 rounded-3xl shadow-2xl">
                        ...
                        <div className="space-y-6 text-gray-300 leading-relaxed font-light">
                            ...
                            <p>
                                If you choose to provide Qube with a third party’s personal information (such as name, email, and phone number), you represent that you have the third party’s permission to do so. Examples include forwarding reference or marketing material to a friend or sending job referrals. Third parties may unsubscribe from any future communication following the link provided in the initial message. In some instances, Qube and the third parties we engage may automatically collect data through cookies, web logs, web beacons, and other similar applications. This information is used to better understand and improve the usability, performance, and effectiveness of the website and to help tailor content or offers for you.
                            </p>
                            <p>
                            ...
                            <h3 className="text-2xl font-semibold mt-8 mb-4 text-white">Uses of Your Personal Information</h3>
                            <p>We may use your personal information for the purposes…</p>
                            <ul className="list-disc pl-6 space-y-2 marker:text-blue-500">
                                ...
                                <li>Sending communications to you, including for marketing or customer satisfaction purposes, either directly from Qube or from our partners.</li>
                            </ul>
                            <p>
                            ...
                            <p>
                                In general, Qube may use your Registration Data and/or other information or data we receive or collect, as well as data we derive or infer from combinations of the foregoing, for a variety of purposes, such as:
                            </p>
                            <ul className="list-disc pl-6 space-y-2 marker:text-blue-500">
                            ...
                            <p>The Service may share information we receive or collect in a variety of ways, such as:</p>
                            <div className="bg-white/5 p-6 rounded-xl space-y-4 border border-white/5">
                                <p>
                                    <strong className="text-white block mb-1">Sharing of Personally Identifiable Information:</strong> We do not share personally identifiable information with third parties other than as described in this policy. However, we may share your information, including personally identifiable information, in order to (i) protect or defend the legal rights or property of Qube, or the legal rights of our business partners, employees, agents, and contractors (including enforcement of our agreements); (ii) protect the safety and security of Qube users or members of the public including acting in urgent circumstances; (iii) protect against fraud or to conduct risk management; or (iv) comply with the law, legal process, or legal requests. Additionally, we may share your data, including any personally identifiable information, with our successor in interest in the event of a corporate reorganization, merger, or sale of all or substantially all of our assets.
                                </p>
                                <p>
                                    <strong className="text-white block mb-1">Sharing of device data:</strong> Qube may share information from devices you use to access the Service with its advertising and other partners. We share this information for a variety of purposes such as advertising frequency capping, tracking advertising conversion events, estimating the number of unique users, security and fraud detection, targeted advertising, debugging problems with the Service, and for providing you with more relevant advertisements.
                                </p>
                                <p>
                            ...
                            <h3 className="text-2xl font-semibold mt-8 mb-4 text-white">Access to and Accuracy of Your Personal Information</h3>
                            <p>
                            ...
                            <h3 className="text-2xl font-semibold mt-8 mb-4 text-white">Your Choices and Selecting Your Communication Preferences</h3>
                            <p>
                            ...
                            <ul className="list-disc pl-6 space-y-2 marker:text-blue-500">
                                ...
                                <li>
                                    By sending us a message through email or by mail to: Qube TECHNOLOGIES PVT. LTD. Plot No.102, Survey No, 41 & 42, Kavuri Hills Phase 1, beside line of Jubilee Ridge Hotel, Guttala_Begumpet, Madhapur, Telangana, 500033
                                </li>
                            </ul>
                            <p>
                            ...
                            <h3 className="text-2xl font-semibold mt-8 mb-4 text-white">Sharing Your Personal Information</h3>
                            <p>
                            ...
                            <ul className="list-disc pl-6 space-y-2 marker:text-blue-500">
                                <li>Within Qube and its parent companies or subsidiaries for purposes of data processing or storage.</li>
                                <li>With Qube business partners or vendors, so that they may share information with you about their products or services. To opt-out of Qube sharing with third parties for their marketing purposes, click here.</li>
                                ...
                                <li>With law enforcement officials, government authorities, or other third parties as necessary to comply with legal process or meet national security requirements; protect the rights, property, or safety of Qube, its business partners, you, or others; or as otherwise required by applicable law.</li>
                            ...
                            <h3 className="text-2xl font-semibold mt-8 mb-4 text-white">Security of Your Personal Information</h3>
                            <p>
                                We intend to protect the personal information entrusted to us and treat it securely in accordance with this Privacy Statement. Qube implements physical, administrative, and technical safeguards designed to protect your personal information from unauthorized access, use, or disclosure. We also contractually require that our suppliers protect such information from unauthorized access, use, and disclosure. The Internet, however, cannot be guaranteed to be 100% secure, and we cannot ensure or warrant the security of any personal information you provide to us.
                            </p>

                            <h3 className="text-2xl font-semibold mt-8 mb-4 text-white">Retention of Personal Information</h3>
                            <p>
                            ...
                            <ul className="list-disc pl-6 space-y-2 marker:text-blue-500">
                                ...
                                <li>
                                    Click stream behavior. This includes, for example, the pages you view and the links you click. These tools help make your visit to our website easier, more efficient, and more valuable by providing you with a customized experience and recognizing you when you return.
                                </li>
                            </ul>
                            <p>
                            ...
                            <h3 className="text-2xl font-semibold mt-8 mb-4 text-white">Linked Websites</h3>
                            <p>
                            ...
                            <p>
                                Qube encourages parents and guardians to take an active role in their children’s online activities. Qube does not knowingly collect personal information from children without appropriate parental or guardian consent. If you believe that we may have collected personal information from someone under the applicable age of consent in your country without proper consent, please let us know using the methods described in the Contact Us section and we will take appropriate measures to investigate and address the issue promptly.
                            </p>
