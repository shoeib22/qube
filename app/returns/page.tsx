      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-12 text-gray-400 leading-relaxed">
          <section>
            ...
            <p>We offer a 10-day return window for most Qube devices. Items must be in their original packaging and in the same condition that you received them.</p>
          </section>

          <section>
            <h2 className="text-white text-lg font-bold mb-4 uppercase tracking-wider">Warranty</h2>
            <p>All Qube automation products come with a 1-year comprehensive replacement warranty against manufacturing defects.</p>
          </section>
